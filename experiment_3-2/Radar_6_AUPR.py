...
# darkening_factor = 0.75  #AUROC
darkening_factor = 1  #AUPR
...
darker_colors = darken_color('plum', darkening_factor)
...
# 微调标题位置以避免与最外环的值重叠
ax.set_title('AUPR', size=15, color='k', position=(0.5, 1.15), horizontalalignment='center')

plt.savefig('./radar_train_AUPR.jpg',dpi=2000)
plt.savefig('./radar_train_AUPR.pdf',dpi=2000)
